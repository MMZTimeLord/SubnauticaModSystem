...
{
#pragma warning disable CS0246 // The type or namespace name 'HarmonyPatchAttribute' could not be found (are you missing a using directive or an assembly reference?)
#pragma warning disable CS0246 // The type or namespace name 'HarmonyPatch' could not be found (are you missing a using directive or an assembly reference?)
    [HarmonyPatch(typeof(StorageContainer))]
#pragma warning restore CS0246 // The type or namespace name 'HarmonyPatch' could not be found (are you missing a using directive or an assembly reference?)
#pragma warning restore CS0246 // The type or namespace name 'HarmonyPatchAttribute' could not be found (are you missing a using directive or an assembly reference?)
#pragma warning disable CS0246 // The type or namespace name 'HarmonyPatchAttribute' could not be found (are you missing a using directive or an assembly reference?)
#pragma warning disable CS0246 // The type or namespace name 'HarmonyPatch' could not be found (are you missing a using directive or an assembly reference?)
	[HarmonyPatch("Awake")]
#pragma warning restore CS0246 // The type or namespace name 'HarmonyPatch' could not be found (are you missing a using directive or an assembly reference?)
